...
export const ActivityHistoryIcon: React.FC<ActivityHistoryIconProps> = ({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 512.001 512.001" fill="none">
      <Path
        d="M469.333,42.666H277.335V21.333C277.335,9.552,267.783,0,256.001,0c-11.782,0-21.333,9.552-21.333,21.333v21.333H42.67
      ...
      />
      <Path
        d="M401.819,149.187c-8.33-8.331-21.838-8.331-30.169,0l-85.481,85.479l-45.253-45.256
